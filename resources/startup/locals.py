...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to Humanoid, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    try:
        os.system("rm -rf Humanoid")
    except BaseException:
        pass
    os.system("git clone https://github.com/TeamHumanoid/Humanoid")
    print("\n\nDone")
    os.chdir("Humanoid")
    clear_screen()
    print(a)
    ...
    all_done = "# Humanoid Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
    ...
    if isitdone == "y":
        # https://github.com/TeamHumanoid/Humanoid/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
        f.close
    elif isitdone == "n":
    ...
    print(a)
    print("\nStarting Humanoid...")
    os.system("python3 -m pyHumanoid")
