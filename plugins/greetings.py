...
@Humanoid_cmd(pattern="setwelcome")
...
@Humanoid_cmd(pattern="clearwelcome$")
...
@Humanoid_cmd(pattern="getwelcome$")
...
@Humanoid_cmd(pattern="setgoodbye")
...
@Humanoid_cmd(pattern="cleargoodbye$")
...
@Humanoid_cmd(pattern="getgoodbye$")
...
@Humanoid_cmd(pattern="thankmembers (on|off)")
