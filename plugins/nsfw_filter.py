...
from pyHumanoid.functions.nsfw_db import *
...
@Humanoid_cmd(pattern="remnsfw", admins_only=True)
async def remnsfw(e):
    rem_nsfw(e.chat_id)
        ...
        if nsfw:
            ...
            if NWARN.get(e.sender_id):
                ...
                if count < 3:
                    ...
                    return await Humanoid_bot.send_message(
                        chat,
                ...
                if "mute" in action:
                    ...
                    try:
                        await Humanoid_bot.kick_participant(chat, e.sender_id)
                        await Humanoid_bot.send_message(
                            chat,
                            f"NSFW Warn 3/3 to [{e.sender.first_name}](tg://user?id={e.sender_id})\n\n**Action Taken** : {action}",
                        )
