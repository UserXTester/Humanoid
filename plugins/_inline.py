...
SUP_BUTTONS = [
    [
        Button.url("Repo", url="https://github.com/TeamHumanoid/Humanoid"),
        Button.url("Addons", url="https://github.com/TeamHumanoid/HumanoidAddons"),
    ],
    [Button.url("Support", url="t.me/HumanoidSupport")],
]
...
async def _(event):
    ...
    if len(changelog_str) > 1024:
        ...
        file = open(f"Humanoid_updates.txt", "w+")
...
async def _(e):
    button = [
        ...
        [
            Button.switch_inline(
                "Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ",
                query="go TeamHumanoid",
                same_peer=True,
            ),
            Button.switch_inline(
                "Sᴇᴀʀᴄʜ Oɴ Yᴀʜᴏᴏ",
                query="yahoo TeamHumanoid",
                same_peer=True,
            ),
        ],
        [
