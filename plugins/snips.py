...
from pyHumanoid.functions.snips_db import *
    ...
    if x:
        ...
        if k:
            ...
            if rep:
                ...
                await Humanoid_bot.send_message(e.chat_id, msg, file=media)
                await e.delete()
